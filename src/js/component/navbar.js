  ...
  return (
    <>
      <nav className="container navbar navbar-expand-lg navbar-dark bg-dark d-flex position-relative">
        ...
        <div className="justify-content-end w-100 borde d-md-none d-sm-none d-lg-flex d-xl-flex d-xxl-flex">
        ...
        <div className="d-md-flex d-sm-flex d-lg-none d-xl-none d-xxl-none justify-content-end">
          <div
            className="p-2 collapse navbar-collapse"
